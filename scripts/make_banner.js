...
<svg viewBox="0 0 ${bannerWidth} ${bannerHeight}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g transform="translate(60, 140)">
        ...
        <g transform="translate(150, 0)">
            ...
            <text x="2" y="128" font-family="'Inter', -apple-system, sans-serif" font-weight="500" font-size="22" fill="#0284C7" opacity="0.82">Freeze Every Frame You Love</text>
            <text x="2" y="160" font-family="'Inter', -apple-system, sans-serif" font-weight="400" font-size="20" fill="#0284C7" opacity="0.7">High-Performance Frame Capture</text>
